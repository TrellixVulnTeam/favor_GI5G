...
This is currently very messy because I'm mostly using it for myself. Also changes frequently.
 - Get our types worked out - the interactions with JVM means we need to more strictly define how many bits our ints/longs are
 - More thorough SkypeManager and EmailManager tests; we have groundwork laid already
