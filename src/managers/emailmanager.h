...
namespace favor {
    ...
    private:
        ...
        string searchCommand(bool sent, shared_ptr<const list<Address>> addresses, long startUid, long endUid);
        ...
        void fetchFromFolder(favor::shared_ptr<vmime::net::folder> folder, shared_ptr<const list<Address>> addresses, bool catchUp);
    };
}
