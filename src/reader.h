...
namespace favor {
    namespace reader {
        ...
        shared_ptr<vector<Message>> queryAll(const AccountManager* const account, Key keys, time_t fromDate, time_t untilDate, bool sent);
        ...
        double averageAll(const AccountManager* const account, const Key key, time_t fromDate, time_t untilDate, bool sent);
        long sumAll(const AccountManager* const account, const Key key, time_t fromDate, time_t untilDate, bool sent);
